...
type FakeFGV002Controller struct {
	act            *actor.Actor
	ID             uuid.UUID
...
// New
func NewFakeFGV002(name string) *FakeFGV002Controller {
	ctrl := &FakeFGV002Controller{
		ID:             uuid.New(),
...
func (c *FakeFGV002Controller) handleMessage(msg message.Message) bool {
...
func (c *FakeFGV002Controller) handleReply(msg message.Message) bool {
	logrus.WithFields(logrus.Fields{
...
func (c *FakeFGV002Controller) Send(msg message.Message) {
	c.act.NoReply(msg.Reply())
}

func (c *FakeFGV002Controller) ReceiveAPIMessage(msg message.Message) {
	c.act.NoReply(msg.Reply())
}

func (c *FakeFGV002Controller) ControllerNextTurn(msg message.Message) {
	c.nextTurn(msg) // will move or attack.
	c.act.NoReply(msg.Reply())
}

func (c *FakeFGV002Controller) BattleStart(msg message.Message) {
...
func (c *FakeFGV002Controller) BattleEnd(msg message.Message) {
...
func (c *FakeFGV002Controller) ControllerAttacked(msg message.Message) {
	logrus.WithFields(logrus.Fields{
...
func (c *FakeFGV002Controller) EntitiesStateChanged(msg message.Message) {
	logrus.WithFields(logrus.Fields{
		"Controller": c.act.Name(),
		"RequestId":  msg.RequestId.String()[0:8],
...
func (c *FakeFGV002Controller) GetStateReply(msg message.Message) {
}

func (c *FakeFGV002Controller) GetGridStateReply(msg message.Message) {
	c.Grid = msg.Content.(rulermethods.GetGridStateReply).Grid
}

func (c *FakeFGV002Controller) GetEntitiesStateReply(msg message.Message) {
	logrus.WithFields(logrus.Fields{
		"Controller": c.act.Name(),
		"RequestId":  msg.RequestId.String()[0:8],
...
func (c *FakeFGV002Controller) ControllerMoveReply(msg message.Message) {
	c.afterMoveAttack(c.KnownEntities, msg)
}

func (c *FakeFGV002Controller) ControllerAttackReply(msg message.Message) {
	logrus.WithFields(logrus.Fields{
...
func (c *FakeFGV002Controller) selectNearestFoe(currentEntity entity.Entity, entities map[uuid.UUID]entity.Entity) (entity.Entity, error) {
	nearestid := uuid.Nil
	minDist := 10000
...
func (c *FakeFGV002Controller) preparePathToEntity(pos position.Position, grd *grid.Grid, ent entity.Entity) []position.Position {
...
func (ctl *FakeFGV002Controller) nextTurn(msg message.Message) {
...
func (ctl *FakeFGV002Controller) afterMoveAttack(knownEntities map[uuid.UUID]entity.Entity, msg message.Message) {
	if msg.HasError {
		ctl.ruler.SendActor(message.Create(nil, rulermethods.EndOfTurn{
...
// Notify Actor
func (c *FakeFGV002Controller) NotifyActor(msg message.Message) {
	c.act.Notify(msg)
}

func (c *FakeFGV002Controller) SendActor(msg message.Message, callback chan message.Message) {
	c.act.Send(msg, callback)
}

func TestRulerControllerFullGameV002(t *testing.T) {
	...
	ruler := NewRuler()
	ctrl := NewFakeFGV002("Fake1")
	ctrl2 := NewFakeFGV002("Fake2")
