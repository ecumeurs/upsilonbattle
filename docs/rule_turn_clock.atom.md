...
## THE RULE / LOGIC
- When an entity's turn officially begins (represented by `ControllerNextTurn` under [[upsilonapi:api_ruler_methods]]), a timer of exactly **30.0 seconds** begins counting down on the server.
